...
if game.Players.localPlayer:IsInGroup(34406290) then
    getgenv().gay = true
else
    getgenv().gay = false
end
...
local tween = ts:Create(Char.HumanoidRootPart, TweenInfo.new(0.1), {CFrame = CFrame.new(x, -280, z)})
tween:Play()
